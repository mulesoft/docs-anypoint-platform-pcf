...
. Ensure you have installed the cf CLI.
. https://anypoint-anywhere.s3.amazonaws.com/0-pcf-buildpack/space_configuration_tool_1.6.1.zip?Signature=a5dJMDDo6P8vDPLC2LZC3y3oQKU%3D&Expires=1693292271&AWSAccessKeyId=AKIAJLQK3BRL7BNERD4Q[Download] the Space Configuration Tool.
