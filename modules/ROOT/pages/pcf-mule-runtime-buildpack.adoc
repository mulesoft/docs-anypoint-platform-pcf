...
This current version of the MuleSoft Runtime buildpack is based on the Pivotal Cloud Foundry Java Buildpack, version 4.2. Compatibility is based on the base version of the Java buildpack with the PCF version.

You can use this buildpack to deploy Mule applications and API gateways.

. Contact your customer success representative to request the buildpack for the Mule runtime version.
