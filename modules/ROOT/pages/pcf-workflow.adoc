...
+
* https://docs.pivotal.io/pivotalcf/2-3/installing/index.html[PCF version 2.3]
* https://docs.pivotal.io/pivotalcf/2-2/installing/index.html[PCF version 2.2]
* https://docs.pivotal.io/pivotalcf/2-1/installing/index.html[PCF version 2.1]
* https://docs.pivotal.io/archives/pcf-docs-1.8.pdf[PCF version 1.8]
* https://docs.pivotal.io/archives/pcf-docs-1.7.pdf[PCF version 1.7]
...
+
.. After installing and configuring the previous components, you can deploy Mule applications to your PCF installation using the cf CLI.
