...
+
The PCF Space Configuration Tool installs Anypoint Platform services in a PCF space. See xref:pcf-space-config.adoc[To Run the PCF Space Configuration Tool] for more information.
