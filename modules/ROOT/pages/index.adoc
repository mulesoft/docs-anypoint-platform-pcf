...
. For API Manager 2.0, perform the steps in xref:api-manager/2.x/configure-autodiscovery-3-task.adoc[Configuring API Gateway API Autodiscovery in a Mule 3 Application].
