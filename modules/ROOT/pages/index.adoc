...
The Anypoint Platform for PCF solution enables you to create and deploy Mule applications and proxies to PCF. A proxy application intercepts traffic to a non-Mule application, enabling you to apply policies and view usage metrics.

If you are using Anypoint Platform for PCF with Anypoint Platform Private Cloud Edition (PCE) and you have multiple PCF installations, each must be linked to its own separate installation of PCE.
